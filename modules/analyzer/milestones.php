...
if (!$lg_settings['ana']['anon_records']) {
  $sql .= "SELECT \"players:matches\", playerid, COUNT(distinct matchid) value FROM matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  ...
  $sql .= "SELECT \"players:kills\", playerid, SUM(kills) value FROM matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:deaths\", playerid, SUM(deaths) value FROM matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:assists\", playerid, SUM(assists) value FROM matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:contribution\", playerid, SUM(kills+assists) value FROM matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:creeps_killed\", playerid, SUM(lastHits) value FROM matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:creeps_denies\", playerid, SUM(denies) value FROM matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";

  $sql .= "SELECT \"players:courier_kills\", playerid, SUM(couriers_killed) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:roshan_kills\", playerid, SUM(roshans_killed) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:hero_damage\", playerid, SUM(heroDamage) value FROM matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  ...
  $sql .= "SELECT \"players:wards_destroyed\", playerid, SUM(wards_destroyed) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:buybacks\", playerid, SUM(buybacks) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:stacks\", playerid, SUM(stacks) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:pings\", playerid, SUM(pings) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";

  $sql .= "SELECT \"players:rampages\", playerid, SUM(multi_kill >= 5) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:godlikes\", playerid, SUM(streak >= 9) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:playtime\", playerid, SUM(m.duration) value 
    FROM matchlines ml JOIN matches m ON ml.matchid = m.matchid 
    GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
  $sql .= "SELECT \"players:time_dead\", playerid, SUM(time_dead) value FROM adv_matchlines GROUP BY playerid ORDER BY value DESC LIMIT $avg_limit;";
}
...
if ($lg_settings['main']['teams']) {
  ...
  $sql .= "SELECT \"teams:wins\", teamid, SUM(NOT m.radiantWin XOR tm.is_radiant) value 
    FROM teams_matches tm JOIN matches m ON tm.matchid = m.matchid
  ...
  $sql .= "SELECT \"teams:playtime\", teamid, SUM(m.duration) value 
    FROM matches m JOIN teams_matches tm ON m.matchid = tm.matchid
    GROUP BY teamid ORDER BY value DESC LIMIT $avg_limit;";
}
