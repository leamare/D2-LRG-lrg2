<?php
  $strings['en'] = array(
    ...
    "desc_heroes_pairs" => "This section contains stats for most common hero pairs. Minimum amount of matches for pairs is set to %limh%.",
    ...
    "desc_players_pairs" => "This section contains stats for most common player pairs. Minimum amount of matches for pairs is set to %limh%.",
    "desc_players_trios" => "This section contains stats for most common player trios. Minimum amount of matches for trios is set to %liml%.",
