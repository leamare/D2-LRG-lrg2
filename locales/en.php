...
$strings['en'] = [
  ...
  "items_stats_desc" => "Winrate shifts are differences in winrate compared to the item's winrate overall. Values are for when the item wasn't bought (higher is better), early (Q1) and late (Q3) timings (higher is better). Winrate gradient per minute shows how winrate changes with every minute of the item's delayed purchase timing. Item timings values can be used to restore the normal distribution, where Q1, median and Q3 mean the first, second and third quantiles respectively.",
  "items_boxplots_timings_desc" => "Boxplots represent distribution of item timings. White line inside of the boxes represents the item's winrate over time. Items without distribution (Q1 = Q2 and low number of matches) are not shown.",
  "items_combos_overview_desc" => "This section shows the most often occuring item pairs, as well as their stats, filtered by the thied quantile in number of matches together for item pairs. Timing difference shows the difference in purchase time of the first item compared to the second one. Expectation is the expected number of purchases together. Deviation represents how ofthen these items are picked up together on purpose (higher positive numbers are better). Percentage is the deviation's part of the total number of purchases together.",
